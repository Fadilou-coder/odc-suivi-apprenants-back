...
public class PretFixture implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        pretRepository.saveAll(Arrays.asList(
                new Pret("Reference", "En cours", apprenantRepository.findByEmail("apprenant0@gmail.com").get(), materielRepository.findByLibelleAndAndDescriptionAndArchiveFalse("Machine", "Dell Core i5").get())
        ));
    }
}
